			...
			<div class="card-box">
				...
				<div class="widget-box-2">
					...
					<div class="am-progress am-progress-xs am-margin-bottom-0">
						<div class="am-progress-bar" style="width: 80%">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="card-box">
				...
				<div class="widget-box-2">
					...
					<div class="am-progress am-progress-xs am-margin-bottom-0" style="background: rgba(255, 138, 204, 0.2);">
						<div class="am-progress-bar progress-bar-pink" style="width: 80%">
						</div>
					</div>
				</div>
			</div>
	...
	<div class="am-g">
		...
		<div class="am-u-md-4">
			<div class="card-box">
				...
				<div id="index-pie-1" style="height: 345px;height: 300px;">
				</div>
			</div>
		</div>
		<div class="am-u-md-4">
			<div class="card-box">
				<h4 class="header-title m-t-0">环形图</h4>
				<div id="index-bar-1" style="height: 345px;height: 300px;">
				</div>
			</div>
		</div>
		<div class="am-u-md-4">
			<div class="card-box">
				<h4 class="header-title m-t-0">环形图</h4>
				<div id="index-line-1" style="height: 345px;height: 300px;">
				</div>
			</div>
		</div>
		<!-- Row end -->
				...
				<div class="inbox-widget nicescroll" style="height: 315px; overflow: hidden; outline: none;" tabindex="5000">
					...
					<div class="inbox-item">
						<div class="inbox-item-img">
							<img src="assets/img/avatar-1.jpg" class="img-circle" alt="">
						</div>
					...
					<div class="inbox-item">
						<div class="inbox-item-img">
							<img src="assets/img/avatar-2.jpg" class="img-circle" alt="">
						</div>
						<p class="inbox-item-author">
							Shahedk
						</p>
					...
					<div class="inbox-item">
						<div class="inbox-item-img">
							<img src="assets/img/avatar-10.jpg" class="img-circle" alt="">
						</div>
						<p class="inbox-item-author">
							Tomaslau
						</p>
					...
					<div class="inbox-item">
						<div class="inbox-item-img">
							<img src="assets/img/avatar-4.jpg" class="img-circle" alt="">
						</div>
						<p class="inbox-item-author">
							Stillnotdavid
						</p>
					...
					<div class="inbox-item">
						<div class="inbox-item-img">
							<img src="assets/img/avatar-5.jpg" class="img-circle" alt="">
						</div>
						<p class="inbox-item-author">
							Kurafire
						</p>
			...
			<div class="card-box">
				...
				<div class="am-scrollable-horizontal am-text-ms" style="font-family: '微软雅黑';">
					...
					<tr>
						...
						<td>
							<span class="label label-pink">未开展</span>
						</td>
						<td>
							Coderthemes
						</td>
					...
					<tr>
						...
						<td>
							<span class="label label-purple">进行中</span>
						</td>
						<td>
							Adminto admin
						</td>
					...
					<tr>
						...
						<td>
							<span class="label label-primary">即将开始</span>
						</td>
						<td>
							Adminto admin
						</td>
